    ...
    return(
        <div>
            ...
            {isLoad ? 
                ...
                { kuki.get("user_id") || isShow ? null : <Alert onClose={() => { setIsShow(true) }} variant="outlined" severity="warning" sx={{ mb: 2, mt: 3 }}><span style={{ fontWeight: "bold" }}>PERHATIKAN!</span>, silahkan login terlebih dahulu untuk bisa mengisi form feedback.</Alert> }
                    <h2>Feedback Bantuan Sosial Masyarakat</h2>
                    <div className="feed-form">
                        <Formik
                            initialValues={{ kd_masukan: '', nm_depan: '', nm_belakang: '', pesan: '', user_id: '' }}
            ...
            <footer className="footer masukan_foot">
                <h1>Basoma</h1>
                    ...
                    <ul>
                        ...
                        <li>
                            <NavLink
                                exact="true"
                                to="/tentang"
                                className={({ isActive }) => (isActive || data ? 'active_foot' : 'unselected_foot')}
                            >Tentang</NavLink>
                        </li>
                    </ul>
                </div>
