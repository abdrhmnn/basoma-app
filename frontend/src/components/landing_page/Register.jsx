...
const Register = () => {
    ...
    const schemaRegister = Yup.object({
        ...
        kf_password: Yup.string().oneOf([Yup.ref('password'), null], 'Password tidak sama!')
    });
        ...
        <div className="register">
            ...
            {isRegister ?
                <div className="register_auth">
                    ...
                    <Formik
                        initialValues={{ nm_depan: '', nm_belakang: '', username: '', password: '', kf_password: '' }}
                    ...
                    >
                        {(props) => (
                            <form onSubmit={props.handleSubmit}>
                                ...
                                >
                                    <InputLabel
                                        htmlFor="outlined-adornment-kf-password"
                                    >
                                        Konfirmasi Password
                                    </InputLabel>
                                    <OutlinedInput
                                        ...
                                        type={showPasswordKfRegister ? "text" : "password"}
                                        ...
                                        endAdornment={
                                            <InputAdornment position="end">
                                                <IconButton
                                                    edge="end"
                                                    onClick={() =>
                                                        setShowPasswordKfRegister(!showPasswordKfRegister)
                                                    }
                                                >
                                    ...
                                    />
                                    <FormHelperText id="outlined-adornment-kf-password" sx={{ color: "red" }}>
                                        {props.touched.kf_password && props.errors.kf_password}
                                    </FormHelperText>
                                </FormControl>
                                <Button
                                    variant="contained"
                    ...
                    <p style={{
                        marginTop: 10
                    }}>Sudah punya akun? silahkan masuk <Link to="/login" style={{
                        color: "rgb(75, 75, 253)"
                    }}>disini!</Link></p>
                </div>
            :
