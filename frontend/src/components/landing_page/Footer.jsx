...
const Footer = (props) => {
    ...
    const showClassName = () => {
        ...
        else if(bantuanDetailProps) return classNameForFooter = bantuanDetailProps
                    ...
                    <ul>
                        ...
                        <li>
                            <NavLink 
                                exact="true"
                                to="/bantuan"
                                className={({ isActive }) => (isActive || props.active_foot ? 'active_foot' : 'unselected_foot')}
                            >Bantuan</NavLink>
                        </li>
                        <li>
                            <NavLink
                                exact="true"
                                to="/tentang"
                                className={({ isActive }) => (isActive || props.active_masukan ? 'active_foot' : 'unselected_foot')}
                            >Tentang</NavLink>
                        </li>
                    </ul>
                </div>
