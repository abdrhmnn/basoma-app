...
const Bantuan = () => {
    ...
    const ShowBantuanByFilter = (props) => {
        ...
        else if(isSearch) return <BoxBantuanBerhasilSearch data={validShowBantuan} />
            ...
            <div className="bantuan">
                ...
                <div className="search_bantuan">
                    <Formik
                        ...
                        onSubmit={(values, actions) => {
                            ...
                            const validBantuan = namaBantuan.find(e => e === values.cari)
                            navigate({
                                ...
                                axios.get(`http://localhost:5000/bantuan/${validBantuan}`)
                        ...
                        {(props) => (
                            <form onSubmit={props.handleSubmit}>
                                <Field
                                    ...
                                    label="Cari Bantuan"
                                    as={TextField}
                                    error={props.touched.cari && props.errors.cari ? true : false}
                ...
                <div className="bantuan_content">
                    <div className="filtering_bantuan">
                        ...
                        <Formik
                            initialValues={{ kapasitas: '', status: '' }}
                            ...
                            onSubmit={(values, actions) => {
                                ...
                                axios.get(`http://localhost:5000/bantuan/${values.kapasitas}/${values.status}`)
                                .then((res) => {
                            ...
                            {(props) => (
                                <form onSubmit={props.handleSubmit}>
                                    ...
                                    <FormControl component="fieldset" sx={{ mt: 2 }}>
                                        ...
                                        <RadioGroup row name="status" onChange={props.handleChange}>
                                            <FormControlLabel value="tersedia" control={<Radio />} label="Tersedia" />
                                            <FormControlLabel value="berakhir" control={<Radio />} label="Berakhir" />
                                        </RadioGroup>
                                    </FormControl>
                                    <Button
                                        variant="contained"
